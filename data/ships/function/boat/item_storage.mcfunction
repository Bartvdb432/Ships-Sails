...
execute as @e[tag=custom_boat, tag=!fishing_boat, tag=!ice_breaker] on passengers unless items entity @s armor.head #banners if entity @s[type=player, tag =! in_custom_boat] at @s as @e[type=armor_stand,tag=storage_armor_stand] if score @s id = @p id run item replace entity @s armor.head from entity @p armor.head
...
execute as @e[tag=custom_boat, tag=!fishing_boat, tag=!ice_breaker] on passengers if entity @s[type=player] at @s as @e[type=armor_stand,tag=storage_armor_stand] if score @s id = @p id run item replace entity @p armor.head from entity @s weapon.mainhand
execute as @e[tag=custom_boat, tag=!scouting_ship, tag=!ice_breaker] on passengers if entity @s[type=armor_stand, tag=mast] at @s as @e[type=armor_stand,tag=storage_armor_stand] if score @s id = @n id run item replace entity @n armor.head from entity @s weapon.mainhand

execute as @a[nbt=!{RootVehicle:{Entity:{id:"minecraft:boat"}}}] if entity @s[nbt=!{RootVehicle:{Entity:{id:"minecraft:chest_boat"}}}] if items entity @s armor.head #banners at @s as @e[type=armor_stand,tag=storage_armor_stand] if score @s id = @p id run item replace entity @p armor.head from entity @s armor.head
execute as @e[type=armor_stand, tag=mast, tag=!scouting_mast] unless score @s id = @s id run item replace entity @s armor.head with air
