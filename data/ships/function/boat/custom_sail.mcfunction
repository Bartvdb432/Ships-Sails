...
execute as @a[scores={sail=1},tag=holding_banner] at @s as @e[type=armor_stand,tag=storage_armor_stand] if score @s ship_id = @p ship_id run item replace entity @s weapon.mainhand from entity @p weapon.mainhand
execute as @e[type=armor_stand,tag=storage_armor_stand] run item modify entity @s weapon.mainhand ships:sail_item
execute as @a[scores={sail=1},tag=holding_banner] at @s as @e[type=armor_stand,tag=storage_armor_stand] if score @s ship_id = @p ship_id run advancement grant @p only ships:advancement/custom_sail/custom_sail
...
execute as @e[type=armor_stand,tag=storage_armor_stand] at @s as @a[scores={sail=1},tag=in_boat,tag=!banner_replaced_2,tag=!in_fishing_boat,tag=!in_normal_boat] if score @s ship_id = @a[scores={sail=1},tag=in_boat,tag=!banner_replaced_2,tag=!in_fishing_boat,tag=!in_normal_boat,limit=1] ship_id run item replace entity @s armor.head from entity @n weapon.mainhand
