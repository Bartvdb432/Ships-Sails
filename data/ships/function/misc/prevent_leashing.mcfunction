...
execute as @e[type=boat,tag=custom_boat] if score @s anchor_id = @s anchor_id at @s on leasher unless score @s ship_id = @n anchor_id run tag @n add leashed
execute as @e[type=chest_boat,tag=custom_boat] at @s on leasher if score @s anchor_id = @s anchor_id unless score @s ship_id = @n anchor_id run tag @n add leashed
