...
scoreboard players set #anchor_holder id 0
...
execute as @a[scores={anchor=1..},tag=holding_anchor] at @s if score @s id = @n[type=boat,distance=..1,tag=custom_boat,sort=nearest,limit=1] anchor_id run tellraw @s {"text":"This ship already belongs to you","bold":true,"color":"yellow"}
execute as @a[scores={anchor=1..},tag=holding_anchor] at @s if score @n[type=boat,distance=..1,tag=custom_boat,sort=nearest,limit=1] anchor_id > #anchor_holder id unless score @s id = @n[type=boat,distance=..1,tag=custom_boat,sort=nearest,limit=1] anchor_id run tellraw @s {"text":"This ship already belongs to someone else","color":"yellow","bold":true}
...
execute as @a[scores={anchor=1..},tag=holding_anchor] at @s if score @s id = @n[type=chest_boat,distance=..1,tag=custom_boat,sort=nearest,limit=1] anchor_id run tellraw @s {"text":"This ship already belongs to you","bold":true,"color":"yellow","bold":true}
execute as @a[scores={anchor=1..},tag=holding_anchor] at @s if score @n[type=chest_boat,distance=..1,tag=custom_boat,sort=nearest,limit=1] anchor_id > #anchor_holder id unless score @s id = @n[type=chest_boat,distance=..1,tag=custom_boat,sort=nearest,limit=1] anchor_id run tellraw @s {"text":"This ship already belongs to someone else","color":"yellow","bold":true}
...
execute as @e[type=boat,tag=has_anchor] on passengers at @s unless score @s[type=player] id = @e[type=boat,tag=has_anchor,sort=nearest,limit=1] anchor_id run title @s actionbar {"text":"That ship belongs to someone else","color":"yellow"}
execute as @e[type=boat,tag=has_anchor] on passengers at @s unless score @s[type=player] id = @e[type=boat,tag=has_anchor,sort=nearest,limit=1] anchor_id run ride @s dismount

execute as @e[type=chest_boat,tag=has_anchor] on passengers at @s unless score @s[type=player] id = @e[type=chest_boat,tag=has_anchor,sort=nearest,limit=1] anchor_id run title @s actionbar {"text":"That ship belongs to someone else","color":"yellow"}
execute as @e[type=chest_boat,tag=has_anchor] on passengers at @s unless score @s[type=player] id = @e[type=chest_boat,tag=has_anchor,sort=nearest,limit=1] anchor_id run ride @s dismount
